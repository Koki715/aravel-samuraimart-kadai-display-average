                ...
                <div class="row">
                    <div class="col-12">
                        <p class="samuraimart-product-label mt-2">
                            ...
                            <div class="samuraimart-star-rating" data-rate="{{ $recommend_product->average_rating }}"></div>
                            <p>{{ number_format($recommend_product->reviews->avg('score'), 1) }}</p>
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="samuraimart-product-label mt-2">
                            ...
                            <div class="samuraimart-star-rating" data-rate="{{ $recently_product->average_rating }}"></div>
                            <p>{{ number_format($recently_product->reviews->avg('score'), 1) }}</p>
